...
*/
package com.ibm.cloud.appid.android.internal.userprofilemanager;
...
public class UserProfileManagerImpl_Test {
    ...
    public void getUserInfo_happy_flow_no_token_supplied_validate_idToken() {
        ...
        final Response testResponse = new Response() {
            ...
            @Override
            public String getResponseText() {
                return "{\"sub\": \"311a9f74-439d-4741-9347-ae565a0eb137\", \"email\":\"donlonqwerty@gmail.com\"}";
            }
        ...
        userProfileManagerSpy.getUserInfo(new UserProfileResponseListener() {
            ...
            public void onSuccess(JSONObject userInfo) {
                try {
                    assertEquals(userInfo.getInt("sub"), "311a9f74-439d-4741-9347-ae565a0eb137");

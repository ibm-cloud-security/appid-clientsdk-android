...
class ChromeTabActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
            ...
            if(!CustomTabManager.HANDLE_AUTHORIZATION_RESPONSE.equals(action)) {
                ...
                //In case the chrome tab closed by RedirectUriReceiverActivity.
                finish();
            }
    }
